...
type mockGrpcServer struct {
	...
	gracefulStopFn func()
	registerFn     func(srv auth.AuthServiceServer)
}
...
func (m *mockGrpcServer) RegisterAuthService(srv auth.AuthServiceServer) {
	if m.registerFn != nil {
		m.registerFn(srv)
	}
}
...
func (s *ApplicationSuite) TestHttpServerErrorChannel() {
	...
	s.app.NewHTTPServer = func(addr string, handler http.Handler) application.HTTPServer {
